...
Требований без показа: 54. Миссий с несколькими новыми сущностями сразу: 43.
Проверок, выполненных стартовым файлом: 139 (критических: 0).
Подсказок, выдающих ответ: 12 (критических: 8).
...
| `python-core` | python | 58 | 6 | 2 | 1 | 2 | 1 |
