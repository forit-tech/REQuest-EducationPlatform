...
Собрано 06.09.2026, 22:03:39 за 389 мс.

| Периметр | Ошибки | Предупреждения | Наблюдения |
|---|---:|---:|---:|
| Старый контент | 398 | 304 | 59 |
...
Корпус: 75 курсов, 1810 старых заданий, 23 заданий новой модели, 44 навыков, 87 официальных вопросов вузов.
...
| C2.free-check | warning | legacy | 144 |
| C3.duplicate-intro | warning | legacy | 83 |
| C5.fragile-substring | warning | legacy | 48 |
